...
@Route(value = "ChoosePizzaForm1", layout = MainView.class)
@ViewController("jbt_ChoosePizzaForm1")
@ViewDescriptor("choose-pizza-form-1.xml")
@DialogMode(width = "25em", height = "AUTO")
public class ChoosePizzaForm1 extends StandardView {
    ...
    public void onBeforeShow(final BeforeShowEvent event) {
        quantityField.setTypedValue(qty);
    ...
    protected void onPizza_chosenBtnClick(ClickEvent<JmixButton> event) {
        qty = quantityField.getTypedValue();
